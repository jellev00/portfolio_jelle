...
export default function ProjectDetail({ project }: { project: Project }) {
  ...
  return (
    <div className="max-w-[1180px] mx-auto px-[28px] pt-8 pb-6 flex flex-col gap-[14px]">
      ...
      <Link
        href="/"
        className="font-mono uppercase text-xs w-fit px-4 py-2 rounded-full border border-[var(--border)] hover:text-[var(--text)] hover:border-[var(--text2)] transition-colors"
      >
        {t.detail.back}
      </Link>

      <div className="mt-[34px] flex flex-col gap-4">
        <h1 className="text-[76px] max-[900px]:text-[48px] leading-[0.9] font-bold tracking-[-0.045em]">
        ...
        <div className="flex gap-2">
          {project.paperUrl && (
            <a
              ...
              download
              className="font-mono uppercase text-xs px-4 py-[9px] rounded-full bg-[var(--mint)] text-[var(--on-mint)] inline-flex items-center gap-[6px] whitespace-nowrap hover:-translate-y-0.5 transition-transform duration-200"
            >
          ...
          {project.githubUrl && (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="font-mono uppercase text-xs px-4 py-[9px] rounded-full border border-[var(--border)] text-[var(--text)] inline-flex items-center gap-[6px] whitespace-nowrap hover:-translate-y-0.5 transition-transform duration-200"
            >
      ...
      <div className="card mt-[34px] p-[44px] py-11 flex flex-wrap items-center justify-between gap-7">
        <h3 className="text-[38px] font-bold max-w-[24ch] leading-[1.05]">
          {t.detail.interested}
        </h3>
        <Link
          href="/#contact"
